package moudle.main;/*
 * Created by JFormDesigner on Tue May 30 08:06:11 HKT 2023
 */


import bean.Admin;
import moudle.interior.*;
...
public class MainUI extends JFrame{
    ...
    public MainUI(Admin admin) {
        initComponents();
        this.setExtendedState(MAXIMIZED_BOTH);
        fillInformation(admin);
        setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE); // 设置关闭操作为DO_NOTHING_ON_CLOSE
    }
    //初始化个人信息
    public void fillInformation(Admin admin){
        idTxt.setText(admin.getId()+"");
        userNameShowTxt.setText(admin.getUserName());
        userNameTxt.setText(admin.getUserName());
        passwordTxt.setText(admin.getPassword());
        String userDesc = admin.getUserDesc();
        if (MyStringUtils.isEmpty(userDesc)){
            userDescTxt.setText("该用户很懒，什么介绍都没有");
        }else {
            userDescTxt.setText(admin.getUserDesc());
        }
        // 初始化时间
        ...
        timer = new Timer(1000, e -> {
            ...
            timeTxt.setText("\t" + timeStr); // 将已运行时间设置到界面上
        });
        timer.start();
    }
    ...
    private void menuItem2(ActionEvent e) {
        ...
        //设置中心位置
        setInternalFramePosition(table,bookTypeAddInter);
    }
    //图书类别维护
    private void menuItem3(ActionEvent e) {
        // TODO add your code here
        BookTypeManageInter bookTypeManageInter = new BookTypeManageInter();
        //设置中心位置
        setInternalFramePosition(table,bookTypeManageInter);
    }
    //图书添加
    private void menuItem4(ActionEvent e) {
        // TODO add your code here
        BookAddInter bookAddInter = new BookAddInter();
        //设置中心位置
        setInternalFramePosition(table,bookAddInter);
    }
    //图书管理
    private void menuItem5(ActionEvent e) {
        // TODO add your code here
        BookManagerInter bookManagerInter = new BookManagerInter();
        //设置中心位置
        setInternalFramePosition(table,bookManagerInter);
    }
    ...
    private void button1MouseClicked(MouseEvent e) {
        ...
        Admin admin = new Admin(Integer.parseInt(id),userName, password, userDesc);
        int update = new AdminDao().update(admin);
        if (update > 0){
    ...
    private void button2MouseClicked(MouseEvent e) {
        ...
        if(i == 0){
            int delete = new AdminDao().delete(Integer.parseInt(id));
            if (delete > 0){
    ...
    private void initComponents() {
        ...
        //======== table ========
        {
            ...
            //---- label1 ----
            label1.setIcon(new ImageIcon(getClass().getResource("/img/profile.jpg")));
            ...
            userNameShowTxt.setBounds(15, 310, 245, 40);
            ...
            timeTxt.setBounds(15, 385, 245, 40);
        }
